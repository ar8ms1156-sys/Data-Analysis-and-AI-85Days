...
| **عقارات متوسطة (Medium)** | 2,296 | 560.68K SAR | 615.75K SAR | **Undervalued (أقل من القيمة)** | فرصة استثمارية واعدة للتوسع والشراء. |
...
1. **التركيز الاستثماري على العقارات المتوسطة:** توجيه المحافظ الاستثمارية نحو العقارات المتوسطة للاستفادة من هامش النمو المتوقع ($+55K SAR$ لكل عقار).
2. **إعادة تفاوض عقارات الشريحة الكبيرة:** التوصية للمقيميّن العقاريين بمراجعة معايير التقييم للشريحة الكبيرة لتفادي الشراء بأسعار تزيد عن القيمة العادلة السوقية.
3. **تحسين النموذج التنبؤي:** دعم النموذج المتغير ببيانات إضافية (مثل: عمر العقار، القرب من الخدمات الرئيسية والمشاريع الكبرى في الرياض) لرفع دقة التنبؤ ($R^2$).

---

## 💻 8. أدوات العمل والتقنيات (Tech Stack)

* **Microsoft Power BI Desktop:** بناء لوحة القيادة والتصميم البصري التفاعلي.
* **Power Query (M-Code):** عمليات التنظيف والتحويل وتحضير البيانات.
* **DAX Expressions:** تصميم الحسابات ومؤشرات الأداء المتقدمة.
* **Excel / Predictive Model:** إعداد النموذج الحسابي والتنبؤي للأسعار.
* **GitHub:** توثيق المشروع وإدارة النسخ البرمجية.

---

## 🚀 9. كيفية تشغيل المشروع (How to Run)

1. قم بعمل Clone للمستودع عبر الأمر التالي:
   ```bash
   git clone [https://github.com/YourUsername/Riyadh-RealEstate-Valuation-Analytics.git](https://github.com/YourUsername/Riyadh-RealEstate-Valuation-Analytics.git)
   ```
2. افتح ملف المشروع `Riyadh_RealEstate_Predictive_Model.pbix` باستخدام برنامج **Power BI Desktop**.
3. قم بتحديث مصدر البيانات (`Data Source Settings`) في حال تغيير المسار المحلي لديك.
